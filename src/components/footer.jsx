...
const Footer = () => {
  return (
    <div className="m-auto mt-20 px-8 py-3 w-full max-w-[600px] h-26 bg-slate-400 flex flex-col text-center text-slate-700">
      <div className="text-xs font-medium text-gray-50">@made by <span className="underline decoration-indigo-500">toiga_sait_shakirtu</span></div>
      <div className="flex flex-wrap justify-center items-center mt-2 gap-1">
        <a
          href="https://wa.me/87718544450"
          target="_blank"
          without
          rel="noreferrer"
        >
